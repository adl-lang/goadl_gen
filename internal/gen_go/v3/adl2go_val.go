...
func (bg *generator) GoDeclValue(val adlast.Decl) string {
	...
	return bg.GoValue(declTexpr.Value, m)
}

func (bg *generator) GoValue(te adlast.TypeExpr, val any) string {
	defer func() {
		r := recover()
		if r != nil {
